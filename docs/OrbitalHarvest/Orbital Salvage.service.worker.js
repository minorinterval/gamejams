...
/** @type {string} */
const CACHE_VERSION = '1739772414|52569356158';
/** @type {string} */
const CACHE_PREFIX = 'Orbital Salvage-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Orbital Salvage.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Orbital Salvage.html","Orbital Salvage.js","Orbital Salvage.offline.html","Orbital Salvage.icon.png","Orbital Salvage.apple-touch-icon.png","Orbital Salvage.worker.js","Orbital Salvage.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Orbital Salvage.wasm","Orbital Salvage.pck"];
